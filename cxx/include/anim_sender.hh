...
namespace paired_anim {
    ...
    inline constexpr std::array<AnimPair, 4> kPresets{
        ...
        AnimPair{ .label = "KillMoveSneakBackA",
            .attackerEvent = "pa_KillMoveSneakBackA",
            .victimEvent = "KillMoveSneakBackA" },
        AnimPair{ .label = "pa_KillMove2HMStabA",
            .attackerEvent = "pa_KillMove2HMStabA",
            .victimEvent = "KillMove2HMStabA" },
