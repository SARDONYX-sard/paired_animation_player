 ...
 * string. */
    utf8_constexpr14 utf8_nonnull utf8_pure int utf8ncasecmp(const utf8_int8_t* src1, const utf8_int8_t* src2,
        size_t n);
...
#undef utf8_nonnull
    ...
    utf8_constexpr14_impl int utf8casecmp(const utf8_int8_t* src1, const utf8_int8_t* src2) {
        utf8_int32_t src1_lwr_cp = 0, src2_lwr_cp = 0, src1_upr_cp = 0, src2_upr_cp = 0, src1_orig_cp = 0,
                     src2_orig_cp = 0;
   ...
   * byte then return haystack */
    ...
    utf8_constexpr14_impl utf8_int8_t* utf8codepoint(const utf8_int8_t* utf8_restrict str,
        ...
        if (0xf0 == (0xf8 & str[0])) {
            ...
            *out_codepoint =
                ((0x07 & str[0]) << 18) | ((0x3f & str[1]) << 12) | ((0x3f & str[2]) << 6) | (0x3f & str[3]);
            str += 4;
